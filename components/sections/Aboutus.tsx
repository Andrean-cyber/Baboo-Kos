...
>
      ...
      <div
  className={cn(
    "max-w-5xl text-justify hyphens-auto text-sm leading-7 text-zinc-600 transition-all duration-700 delay-300 md:text-center md:text-[16px] md:leading-8 md:hyphens-none",
