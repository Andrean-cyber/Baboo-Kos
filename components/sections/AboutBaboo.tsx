    ...
    <div className="w-full max-w-[400px] md:max-w-full">
      <AnimatedList delay={1800}>
        {managementNotifications.map((item) => (
              ...
              <div className="flex md:flex-row flex-col md:justify-center md:items-stretch gap-3 lg:gap-5 mt-2 md:mt-0 w-full">
                ...
                <div className="flex flex-row md:flex-col flex-1 gap-3 md:max-w-[220px]">
                  <div className="flex items-center bg-white shadow-sm p-2 md:pr-4 rounded-2xl md:rounded-full w-1/2 md:w-full">
                    <img src="/about.jpg" alt="Baboo Kos" className="rounded-full w-8 h-8 object-cover shrink-0" />
                    <div className="ml-2">
                  ...
                  <div className="flex flex-col justify-center bg-white shadow-sm p-3 md:p-4 rounded-2xl w-1/2 md:w-full md:h-full">
                    ...
                    <p className="text-[9px] text-zinc-500 xl:text-[11px] leading-relaxed">Membantu setiap owner kos go digital.</p>
                  </div>
                </div>
              </div>
          ...
          <Link 
            href="/simulation"
            className="group relative block bg-zinc-200 shadow-sm rounded-[2rem] md:rounded-[2.5rem] w-[85vw] max-w-[850px] h-[520px] md:h-[420px] overflow-hidden snap-center shrink-0 cursor-pointer active:scale-[0.99] transition-transform duration-200"
          >
