...
// Struktur data agar kode bersih dan mudah dikelola
const tcSections = [
  {
    id: "ketentuan-umum",
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="p-4 bg-[#EEF3E8]/50 border border-[#495C29]/10 rounded-xl">
            <span className="font-bold text-zinc-800 text-xs block mb-1">📊 Skema Paket</span>
            <span className="text-zinc-600 text-[11px] leading-relaxed block">Baboo Kos menyediakan beberapa pilihan paket konten short-form (<span className="font-semibold text-[#495C29]">Standart, Deluxe, Superior, Supreme Rate</span>) dengan masa tayang (keep slot) tertentu.</span>
          </div>
          <div className="p-4 bg-[#EEF3E8]/50 border border-[#495C29]/10 rounded-xl">
            <span className="font-bold text-zinc-800 text-xs block mb-1">📹 Kunjungan Lokasi (Footage Gathering)</span>
            <span className="text-zinc-600 text-[11px] leading-relaxed block">Untuk paket Deluxe, Superior, dan Supreme, tim kreator kami akan datang langsung melakukan visit ke lokasi kos untuk pengambilan video. Pemilik wajib memastikan unit dalam keadaan bersih, rapi, dan memberikan akses penuh saat jadwal syuting yang disepakati.</span>
          </div>
        </div>
        <div className="p-4 bg-amber-50/60 border border-amber-200/60 rounded-xl">
          ...
          <p className="text-amber-800/90 text-[11px] leading-relaxed">Untuk Paket Standart, aset video sepenuhnya dikirim oleh pemilik unit, dan tim Baboo Kos hanya bertanggung jawab pada proses penyuntingan (editing). Namun, pihak Baboo Kos juga memiliki hak penuh atas penentuan standart kualitas konten laik upload atau tidak. Jika tidak, maka akan diberikan opsi untuk <span className="font-semibold">add on syuting langsung</span> dengan Content Creator kami.</p>
        </div>
        <div className="text-zinc-500 text-[11px] flex items-center gap-1.5 pt-1">
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <div className="border-l-2 border-[#495C29] pl-3">
    ...
    content: (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-4 bg-zinc-50 rounded-xl border border-zinc-100">
          ...
          <p className="text-zinc-500 text-[11px] leading-relaxed">Baboo Kos berfungsi sebagai platform digital penghubung dan penyedia layanan promosi kreatif. Kami tidak bertanggung jawab atas sengketa hukum, kerusakan properti, atau pelanggaran kontrak sewa yang terjadi secara internal antara Pemilik Kos dan Penyewa di kemudian hari.</p>
        </div>
        <div className="p-4 bg-zinc-50 rounded-xl border border-zinc-100">
          <span className="font-bold text-zinc-800 text-xs block mb-1">📈 Performa Konten</span>
          <p className="text-zinc-500 text-[11px] leading-relaxed">Kami memproduksi konten secara profesional menggunakan strategi algoritma terbaru agar berpotensi besar masuk FYP (viral). Namun, Baboo Kos tidak menjamin angka pasti atau target mutlak jumlah penyewa yang masuk, karena keputusan akhir booking sepenuhnya ada di tangan calon penyewa.</p>
        </div>
      </div>
    )
  },
  {
    ...
    content: (
      <div className="space-y-3">
        <div className="flex gap-3 items-center bg-zinc-50 p-3 rounded-xl border border-zinc-100">
          <div className="w-2 h-2 rounded-full bg-[#495C29]" />
          <p className="text-zinc-600 text-xs leading-relaxed flex-1">
            <strong className="text-zinc-800">Kepemilikan Konten:</strong> Semua hasil produksi digital berupa video short-form, foto, logo, dan teks yang dibuat oleh tim Baboo Kos merupakan hak milik intelektual Baboo Kos.
          </p>
        </div>
        <div className="flex gap-3 items-center bg-zinc-50 p-3 rounded-xl border border-zinc-100">
          <div className="w-2 h-2 rounded-full bg-[#495C29]" />
          <p className="text-zinc-600 text-xs leading-relaxed flex-1">
            <strong className="text-zinc-800">Hak Guna Pemilik Kos:</strong> Pemilik kos diberikan hak penuh untuk menggunakan atau repost konten tersebut demi kepentingan promosi unitnya selama masa aktif kontrak paket promosi yang dibeli masih berlaku.
          </p>
        </div>
      </div>
    )
    ...
    <section className="bg-zinc-50/50 min-h-screen">
      ...
      <div className="mx-auto px-4 md:px-8 pb-24 w-full max-w-[1280px] grid grid-cols-1 lg:grid-cols-12 gap-8 mt-4">
        ...
        <div className="hidden lg:block lg:col-span-4 sticky top-6 self-start bg-white p-5 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-zinc-100">
          <h3 className="font-bold text-zinc-800 text-sm mb-4 px-2 uppercase tracking-wider text-zinc-400">Daftar Isi</h3>
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="bg-gradient-to-r from-[#495C29] to-[#5a7035] rounded-3xl p-6 md:p-8 text-white shadow-md relative overflow-hidden group">
            ...
            <div className="relative z-10 max-w-xl">
              ...
              <a 
                href="https://wa.me/6287785338441" // Menyesuaikan nomor marketing dari fitur sebelumnya
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-white hover:bg-zinc-50 text-[#495C29] font-bold text-xs px-5 py-3 rounded-xl transition-all shadow-sm active:scale-95"
              >
